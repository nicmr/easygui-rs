...
/// 
/// Taken from the example sections of the official conrod respository
pub fn examplebox(ui: &mut conrod::UiCell, app: &mut DemoApp) {
    ...
    for _press in widget::Button::new()
        ...
        .down_from(ids.introduction, 60.0)
        .w_h(side, side)
        .set(ids.button_cards, ui)
    {
    ...
    widget::tabs::Tabs::new(&[(ids.shapes_title, "test")])
        .layout_horizontally()
        .align_middle_x_of(ids.canvas);
